...
| TF | Prix | EMA F/M/S | Aligné | BRK | PB | SELL | Ext% |
|---|---|---|---|---|---|---|---|
| Daily | 30.97 | 29.54 / 29.09 / 30.03 | ⚪ Neutre | 0 | 0 | 0 | 4.8% |
| 4h | 30.88 | 30.27 / 29.18 / 29.21 | ⚪ Neutre | 0 | 0 | 0 | 2.0% |
...
| | |
|---|---|
| Stop-loss suggéré | **30.03** (si touché, P/L = +69.02 CAD) |
| Risque/action | 0.94 CAD |

---

## Règles du jour

- Respecter les stops suggérés (basés sur EMA Slow/Mid/Fast)
- Max 3% de risque par position
- Ne pas ajouter si extension > 8% au-dessus EMA Fast
- EXIT immédiat si signal SELL ou structure cassée (prix < EMA Slow)

_Rapport généré par Portfolio Analyzer V4 · Source positions: TradingView Trading Panel / IBKR Live_